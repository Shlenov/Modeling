...
if __name__ == '__main__':
    ...
    # Параметры слоев
    layers_cont = [LayerContinuous(0.5, 0.65,  eps=2.4, sigma=0.0),
                   LayerContinuous(0.65, 1.05 , eps=4.1, sigma=0.0),
                   LayerContinuous(1.05, 1.112, eps=6, sigma=0.0),
                   LayerContinuous(1.112, eps=5.2, sigma=0.0)
                   ]
